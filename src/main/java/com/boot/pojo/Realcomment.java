...
@Document(collection="real_Comment")//可以省略，如果省略，则默认使用类名小写映射集合
//复合索引  userid  nickname
@CompoundIndex( def = "{'userid': 1, 'nickname': -1}")
public class Realcomment implements Serializable {
    ...
    public Realcomment(long id, String content, Date publishtime, String userid, String nickname, Integer likenum, Integer replynum, String state, long parentid, long articleId, Boolean isLiking) {
        this.id = id;
