<template>
    <div class="system-wrapper">
        ...
        <div class="box border-half" v-if="username">
            <div class="li df-sb border-half-bottom" @click="$router.push('/editInformation')">编辑资料</div>
            <div class="li df-sb border-half-bottom" @click="$router.push('/accountAndSecurity')">账号和安全</div>
        </div>
        ...
        <div class="box esc" @click="esc" v-if="username">退出登录</div>

    </div>
</template>
<script>
    import {Cookie, Local} from 'src/utils/storage'
    export default {
        data () {
            return {
                info: {
